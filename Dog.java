/**
  ...
  * @version (03/16/2021)  
  * @java version 14.0.2
  * The abstract class Dog implements the Mammal and Comparable<T> interfaces. It contains 5 attributes
  * and getter and setter methods that will be inherited in the extended classes. The method that declared
  * in the Mammal interface and the Comparable<T> interface will be implemented in the abstract class Dog 
  */
...
public abstract class Dog implements Mammal, Comparable<Dog>
{
    ...
    //default constructor for the object of class Dog
    public Dog()
    {
    ...
    //constructor for the object of class Dog
    public Dog(String breed, String name, int age, int weight, int price)
    {   
        //initialise instance variables
        this();
        this.breed = breed;
     ...
     * a compareTo() method to compare the price of different breeds of dog
     */
    public int compareTo(Dog dog)
    {  
       if(price < dog.price){
           return -1;
       }else if(price == dog.price){
           return 0;
       }else{
           return 1;
